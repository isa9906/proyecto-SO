...
public class Vista {
	...
	protected JFrame ventana, ventanagantt;
	...
	protected JLabel l1Label, l2Label, l3Label, l4Label, l5Label;
	...
	private void PanelRoundJSF() {
		p6Panel = new JPanel();
		l4Label = new JLabel("Cola de procesos SJF");
	...
	private void PanelPRI() {
		p7Panel = new JPanel();
		l5Label = new JLabel("Cola de procesos Prioridades");
	...
	private void PanelTerceario() {
		...
		p3Panel.setLayout(new GridLayout(3, 3));
	...
	private void panelBloqueo() {
		...
		// t2Tabla.setVisible(false);
		//p4Panel.add(this.scrollPane2);
	}

	private void PanelProceso() {
		p5Panel = new JPanel();
		p5Panel.setLayout(new GridLayout(5, 5));
