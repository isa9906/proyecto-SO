...
import logica.ProcesoQuantum;
import logica.Cola;
import logica.ColaBloqueados;
import logica.Semaforo;
import logica.ProcesoPrioridad;
import logica.multycola;
import logica.ProcesoRafaga;
...
public class Modelo {
    ...
    ColaBloqueados CB;
    Semaforo sem;
    public int envPRI;//Envejecimiento Prioridad    
    public int envJSF;//Envejecimiento JSF
